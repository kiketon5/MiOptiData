    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md mb-6">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          {profile && (
            <p className="text-gray-600 mt-1">
              {profile.name} ({profile.relationship}) - Health trends and
              patterns
            </p>
          )}
        </div>
        ...
        <div className="hidden md:block border-b border-gray-200">
          <nav
            className="flex space-x-6 px-4 md:px-6 overflow-x-auto"
            aria-label="Tabs"
          >
            {tabs.map((tab) => (
              <button
                ...
                } whitespace-nowrap py-3 px-2 border-b-2 font-medium text-sm flex items-center space-x-2`}
              >
                <span>{tab.icon}</span>
                <span>{tab.label}</span>
              </button>
            ...
            {visualTests.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500">
                  No visual acuity test data available
                </p>
              </div>
            )}
          </div>
        ...
        {activeTab === "pressure" && (
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {pressureMeasurements.length > 0 ? (
                      ...
                      {pressureMeasurements.map((measurement) => (
                        <tr key={measurement.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <span
                              className={`${
                                measurement.od_pressure > 21
                                  ? "text-red-600 font-semibold"
                                  : measurement.od_pressure > 18
                                  ? "text-yellow-600"
                                  : "text-green-600"
                              }`}
                            >
                              {measurement.od_pressure
                                ? `${measurement.od_pressure} mmHg`
                                : "-"}
                            </span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <span
                              className={`${
                                measurement.os_pressure > 21
                                  ? "text-red-600 font-semibold"
                                  : measurement.os_pressure > 18
                                  ? "text-yellow-600"
                                  : "text-green-600"
                              }`}
                            >
                              {measurement.os_pressure
                                ? `${measurement.os_pressure} mmHg`
                                : "-"}
                            </span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 capitalize">
              ...
              <div className="text-center py-12">
                <p className="text-gray-500">
                  No eye pressure measurement data available
                </p>
              </div>
            )}
          </div>

  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold mb-2">Welcome, {user?.user_metadata?.full_name || user?.email?.split('@')[0] || 'User'}!</h1>
        <p className="text-lg">Track, manage, and share your eye health metrics in one place.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/profiles/new" className="bg-white p-5 rounded-lg shadow-md hover:bg-gray-50 transition-colors">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mt-1">Create a new profile for yourself or a family member</p>
          </div>
        </Link>
        
        <Link to="/reminders/new" className="bg-white p-5 rounded-lg shadow-md hover:bg-gray-50 transition-colors">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mt-1">Schedule appointments or medication reminders</p>
          </div>
        </Link>
        
        <Link to="/profiles" className="bg-white p-5 rounded-lg shadow-md hover:bg-gray-50 transition-colors">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-sm mt-1">Check your eye health metrics history</p>
          </div>
        </Link>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="/reminders" className="text-blue-600 hover:text-blue-800 text-sm font-medium">View All</Link>
        </div>
        ...
        {reminders.length > 0 ? (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 space-x-4">
                      ...
                      {reminder.reminder_time && (
                        <span>🕐 {new Date(`2000-01-01T${reminder.reminder_time}`).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                      )}
                      {reminder.profile && (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">Set up reminders to stay on top of your eye health appointments</p>
            <button 

...
const Login = () => {
  ...
  return (
    <div className="bg-gray-50 flex flex-col">
      ...
      {/* GOOGLE LOGIN ONLY */}
      {showLogin && (
        <div className="max-w-sm mx-auto mt-16 p-8 bg-white rounded-xl shadow-lg text-center">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
